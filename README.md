...
## Data Process
The official original dataset can be downloaded from [https://www.cathdb.info/](https://www.cathdb.info/). Then create a directory named `CATH4.2` and place the raw data according to the `spilit.json` partitions within it.If you prefer to skip data processing, preprocessed data is available for direct download.  
